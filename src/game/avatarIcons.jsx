...
// Портреты классов — доступны как аватар только игроку, закрепившему за собой
// этот класс (lockedClassId). type: 'image' отличает их от обычных emoji-аватаров
// выше при рендере (см. renderAvatarContent в App.jsx).
export const AVATAR_CLASS_PORTRAITS = [
  { id: 'portrait_pathfinder',   name: 'Следопыт',      group: 'Классы', type: 'image', src: '/icons/classes/pathfinder.webp',   requiresClassId: 'pathfinder' },
  { id: 'portrait_berserker',    name: 'Берсеркер',     group: 'Классы', type: 'image', src: '/icons/classes/berserker.webp',    requiresClassId: 'berserker' },
  { id: 'portrait_battlemaster', name: 'Мастер битвы',  group: 'Классы', type: 'image', src: '/icons/classes/battlemaster.webp', requiresClassId: 'battlemaster' },
  { id: 'portrait_monk',         name: 'Монах',         group: 'Классы', type: 'image', src: '/icons/classes/monk.webp',         requiresClassId: 'monk' },
  { id: 'portrait_shaman',       name: 'Шаман',         group: 'Классы', type: 'image', src: '/icons/classes/shaman.webp',       requiresClassId: 'shaman' },
  { id: 'portrait_archmage',     name: 'Архимаг',       group: 'Классы', type: 'image', src: '/icons/classes/archmage.webp',     requiresClassId: 'archmage' },
];
