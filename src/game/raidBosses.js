...
export const RAID_LOOT_SETS_BY_CLASS = {
  ...
  scorpion: {
    ...
    battlemaster: [
      { name: 'Клешни Скорпиона', itemId: 'raid_scorpion_battlemaster_accessory', slot: 'accessory', stats: { 'Силовая выносливость': 2, 'Гибкость': 1 }, image: '/icons/loot/scorpion/raid_scorpion_battlemaster_accessory.webp' },
      { name: 'Панцирь Скорпиона', itemId: 'raid_scorpion_battlemaster_body', slot: 'body', stats: { 'Силовая выносливость': 2, 'Гибкость': 1 }, image: '/icons/loot/scorpion/raid_scorpion_battlemaster_body.webp' },
      { name: 'Сапоги Скорпиона', itemId: 'raid_scorpion_battlemaster_legs', slot: 'legs', stats: { 'Силовая выносливость': 2, 'Гибкость': 1 }, image: '/icons/loot/scorpion/raid_scorpion_battlemaster_legs.webp' },
      { name: 'Жало Скорпиона', itemId: 'raid_scorpion_battlemaster_weapon', slot: 'weapon', stats: { 'Силовая выносливость': 2, 'Гибкость': 1 }, image: '/icons/loot/scorpion/raid_scorpion_battlemaster_weapon.webp' },
      { name: 'Хватка Скорпиона', itemId: 'raid_scorpion_battlemaster_hands', slot: 'hands', stats: { 'Силовая выносливость': 2, 'Гибкость': 1 }, image: '/icons/loot/scorpion/raid_scorpion_battlemaster_hands.webp' },
      { name: 'Панцирь-маска Скорпиона', itemId: 'raid_scorpion_battlemaster_head', slot: 'head', stats: { 'Силовая выносливость': 2, 'Гибкость': 1 }, image: '/icons/loot/scorpion/raid_scorpion_battlemaster_head.webp' },
    ], // полный сет получен от Антона — 6 предметов (у остальных классов по 5, тут ровно столько, сколько прислано)
    monk: [
