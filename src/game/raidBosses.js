...
export const RAID_LOOT_BY_CLASS = {
  ...
  scorpion: {
    pathfinder:  { name: 'Сапоги Скорпиона',        itemId: 'raid_scorpion_pathfinder',   slot: 'legs',      stats: { 'Выносливость': 4, 'Воля': 2 } },
    berserker:   { name: 'Жало Скорпиона',          itemId: 'raid_scorpion_berserker',    slot: 'weapon',    stats: { 'Сила': 4, 'Упорство': 2 } },
    battlemaster:{ name: 'Клешня Скорпиона',        itemId: 'raid_scorpion_battlemaster', slot: 'weapon',    stats: { 'Силовая выносливость': 4, 'Гибкость': 2 } },
    monk:        { name: 'Панцирь Скорпиона',       itemId: 'raid_scorpion_monk',         slot: 'accessory', stats: { 'Фокус': 4, 'Дисциплина': 2 } },
    shaman:      { name: 'Яд Скорпиона',            itemId: 'raid_scorpion_shaman',       slot: 'accessory', stats: { 'Дух': 4, 'ХП': 2 } },
    archmage:    { name: 'Хитин Скорпиона',         itemId: 'raid_scorpion_archmage',     slot: 'accessory', stats: { 'Интеллект': 4, 'Мышление': 2 } },
  },
  owl: {
