...
export const PROFILE_BACKGROUNDS = [
  { id: 'mountains', name: 'Горы', price: 80, tier: 'basic', image: '/character/profile_backgrounds/mountains.webp', gradient: 'linear-gradient(160deg, #2a3a4a 0%, #1a2530 50%, #0e1620 100%)' },
  { id: 'forest', name: 'Лес', price: 80, tier: 'basic', image: '/character/profile_backgrounds/forest.webp', gradient: 'linear-gradient(160deg, #1e3020 0%, #16241a 50%, #0e1810 100%)' },
  { id: 'desert', name: 'Пустыня', price: 80, tier: 'basic', image: '/character/profile_backgrounds/desert.webp', gradient: 'linear-gradient(160deg, #4a3a1e 0%, #382a16 50%, #201a0c 100%)' },
  { id: 'ocean', name: 'Океан', price: 90, tier: 'standard', image: '/character/profile_backgrounds/ocean.webp', gradient: 'linear-gradient(160deg, #123a4a 0%, #0e2a38 50%, #081a24 100%)' },
  { id: 'dojo', name: 'Додзё', price: 120, tier: 'standard', image: '/character/profile_backgrounds/dojo.webp', gradient: 'linear-gradient(160deg, #3a2418 0%, #2a1a10 50%, #180e08 100%)' },
  { id: 'library', name: 'Библиотека', price: 120, tier: 'standard', image: '/character/profile_backgrounds/library.webp', gradient: 'linear-gradient(160deg, #3a2a3a 0%, #261a28 50%, #150e18 100%)' },
  { id: 'volcano', name: 'Вулкан', price: 130, tier: 'advanced', image: '/character/profile_backgrounds/volcano.webp', gradient: 'linear-gradient(160deg, #4a1e12 0%, #38140e 50%, #200a08 100%)' },
  { id: 'temple', name: 'Древний храм', price: 130, tier: 'advanced', image: '/character/profile_backgrounds/temple.webp', gradient: 'linear-gradient(160deg, #3a3018 0%, #2a2210 50%, #181208 100%)' },
  { id: 'aurora', name: 'Северное сияние', price: 160, tier: 'premium', image: '/character/profile_backgrounds/aurora.webp', gradient: 'linear-gradient(160deg, #123a30 0%, #0e2a3a 50%, #0a1428 100%)' },
  { id: 'crystalcave', name: 'Кристальная пещера', price: 160, tier: 'premium', image: '/character/profile_backgrounds/crystalcave.webp', gradient: 'linear-gradient(160deg, #2a1a4a 0%, #1e1238 50%, #100a20 100%)' },
  { id: 'starrysky', name: 'Звёздное небо', price: 200, tier: 'exclusive', image: '/character/profile_backgrounds/starrysky.webp', gradient: 'linear-gradient(160deg, #1a1c3a 0%, #12142a 50%, #0a0b18 100%)' },
  { id: 'cosmos', name: 'Космос', price: 220, tier: 'exclusive', image: '/character/profile_backgrounds/cosmos.webp', gradient: 'linear-gradient(160deg, #1a0e30 0%, #12081f 50%, #060310 100%)' },
];
