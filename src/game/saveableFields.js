...
export const SAVEABLE_FIELDS = [
  ...
  // Трофеи (одноразовый предмет за самую первую победу над боссом) — отдельно от прогресса
  // сета: первая победа даёт трофей, а сбор сета начинается со второй победы.
  { key: 'raidTrophiesReceived',        column: 'raid_trophies_received',    guildVisible: false },
];
