...
export const CHALLENGE_CATALOG = [
  ...
  // ===== БЕГ =====
  {
    id: 'ch_run_rhythm', icon: '/icons/challenges/ch_run_rhythm.webp', category: 'running', duration: 7,
  ...
  {
    id: 'ch_run_endure', icon: '/icons/challenges/ch_run_endure.webp', category: 'running', duration: 14,
  ...
  {
    id: 'ch_run_spirit', icon: '/icons/challenges/ch_run_spirit.webp', category: 'running', duration: 30,
  ...
  // ===== СОН =====
  {
    id: 'ch_sleep_rhythm', icon: '/icons/challenges/ch_sleep_rhythm.webp', category: 'sleep', duration: 7,
  ...
  {
    id: 'ch_sleep_again', icon: '/icons/challenges/ch_sleep_again.webp', category: 'sleep', duration: 14,
  ...
  {
    id: 'ch_sleep_quiet', icon: '/icons/challenges/ch_sleep_quiet.webp', category: 'sleep', duration: 30,
  ...
  // ===== КОМПЛЕКСНЫЕ =====
  {
    id: 'ch_complex_control', icon: '/icons/challenges/ch_complex_control.webp', category: 'complex', duration: 7,
  ...
  {
    id: 'ch_complex_mixed', icon: '/icons/challenges/ch_complex_mixed.webp', category: 'complex', duration: 14,
  ...
  {
    id: 'ch_complex_absolute', icon: '/icons/challenges/ch_complex_absolute.webp', category: 'complex', duration: 30,
