  ...
  pathfinder: [
    {
      ...
      focus: 'Выносливость',
      color: '#ff8c55',
      icon: '/icons/skills/pathfinder/path1_and_skill1_veter_v_spinu.webp',
      skills: [
    ...
    },
    {
      ...
      focus: 'Воля',
      color: '#e8633c',
      icon: '/icons/skills/pathfinder/path2_serdce_ohotnika.webp',
      skills: [
  ...
  berserker: [
    {
      ...
      focus: 'Сила',
      color: '#e8b830',
      icon: '/icons/skills/berserker/path1_iron_grip.webp',
      skills: [
    ...
    },
    {
      ...
      focus: 'Упорство',
      color: '#c9a227',
      icon: '/icons/skills/berserker/path2_endless_lord.webp',
      skills: [
  ...
  battlemaster: [
    {
      ...
      color: '#a07cf6',
      icon: '/icons/skills/battlemaster/path1_tysyacha_shvatok.jpg',
      skills: [
    ...
    },
    {
      ...
      focus: 'Гибкость',
      color: '#8a5cf6',
      icon: '/icons/skills/battlemaster/path2_iskusnaya_borba.jpg',
      skills: [
  ...
  monk: [
    {
      ...
      focus: 'Фокус',
      color: '#5fcf85',
      icon: '/icons/skills/monk/path1_otshelnik.jpg',
      skills: [
    ...
    },
    {
      ...
      focus: 'Дисциплина',
      color: '#4caf6d',
      icon: '/icons/skills/monk/path2_strazh.jpg',
      skills: [
  ...
  shaman: [
    {
      ...
      focus: 'Дух',
      color: '#7090ff',
      icon: '/icons/skills/shaman/path1_duh_mirov.jpg',
      skills: [
    ...
    },
    {
      ...
      focus: 'ХП',
      color: '#4f7cff',
      icon: '/icons/skills/shaman/path2_zhivaya_krepost.jpg',
      skills: [
  ...
  archmage: [
    {
      ...
      focus: 'Интеллект',
      color: '#e870a8',
      icon: '/icons/skills/archmage/path1_architect.webp',
      skills: [
    ...
    },
    {
      ...
      focus: 'Мышление',
      color: '#d6558c',
      icon: '/icons/skills/archmage/path2_thinker.webp',
      skills: [
