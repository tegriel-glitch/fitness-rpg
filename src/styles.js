...
export const styles = {
  ...
  healthBarsMergedWrap: { marginTop: 14, borderRadius: 0, overflow: 'hidden', border: '1px solid #2a2a32' },
  healthBarItem: {},
  healthBarLabelRow: { display: 'flex', alignItems: 'center', justifyContent: 'flex-end', marginBottom: 4 },
  healthBarLabel: { fontSize: 11, color: '#9a9aa2', flex: 1 },
  healthBarValue: { fontSize: 11, color: '#b0b0b8', fontWeight: 700 },
  healthBarTrack: { position: 'relative', height: 10, background: '#1a1a20' },
  healthBarFill: { height: '100%', transition: 'width 0.4s ease' },
  healthBarValueInside: {
    position: 'absolute', top: 0, right: 8, height: '100%',
    display: 'flex', alignItems: 'center',
    fontSize: 8.5, fontWeight: 800, color: 'rgba(255,255,255,0.6)',
    textShadow: '0 1px 2px rgba(0,0,0,0.35)', pointerEvents: 'none',
  },
  healthDebuffsWrap: { display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 6, marginTop: 8 },
  debuffBadge: {
  ...
  passiveCard: {
    position: 'relative', overflow: 'hidden', border: '1px solid', borderRadius: 12,
    padding: 0, margin: 0, width: '100%', display: 'block', background: '#1c1c22',
  ...
  passiveLabel: {
    fontSize: 11.5, fontWeight: 700, color: '#f0f0f4', textShadow: '0 1px 5px rgba(0,0,0,0.85)',
    lineHeight: 1.2,
  },
  activityCard: {
  ...
  streakBadge: {
    position: 'absolute', top: 10, left: 10, background: 'rgba(10,10,13,0.55)',
    border: '1px solid rgba(255,255,255,0.18)', borderRadius: 13, height: 26, minWidth: 26,
    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3, padding: '0 8px',
    fontSize: 11, fontWeight: 700, color: '#e0a868', zIndex: 2,
  },
  cardExpand: {
  ...
  activityCardTextOverlay: {
    ...
    background: 'linear-gradient(180deg, rgba(10,10,13,0.05) 0%, rgba(10,10,13,0.35) 55%, rgba(10,10,13,0.88) 100%)',
  },
  activityCardLabel: {
    fontSize: 12.5, fontWeight: 700, color: '#f0f0f4', lineHeight: 1.25,
    position: 'relative', textShadow: '0 1px 4px rgba(0,0,0,0.7)',
  },
  streakPill: {
  ...
  equippedGearWrap: {
    background: '#1c1c22', border: '1px solid #28282f', borderRadius: 14,
    padding: '10px 6px', display: 'flex', flexDirection: 'column', gap: 14,
  },
  ...
  shopGrid: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 7 },
  shopCard: {
    border: '1px solid', borderRadius: 12, padding: '8px 6px 10px',
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5, textAlign: 'center',
  },
  shopCardIconWrap: {
    width: '100%', aspectRatio: '1 / 1', borderRadius: 10, display: 'flex',
    alignItems: 'center', justifyContent: 'center', marginBottom: 1, overflow: 'hidden',
  },
  shopItemName: { fontSize: 11, fontWeight: 700, color: '#dcdce2', lineHeight: 1.2, minHeight: 27 },
  shopItemBonus: { fontSize: 9.5, lineHeight: 1.25 },
