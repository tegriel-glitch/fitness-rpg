...
export const styles = {
  ...
  shopGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(152px, 1fr))', gap: 10 },
  shopCard: {
    border: '1px solid', borderRadius: 14, padding: '10px 10px 12px',
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, textAlign: 'center',
  },
  shopCardIconWrap: {
    width: '100%', aspectRatio: '1 / 1', borderRadius: 11, display: 'flex',
    alignItems: 'center', justifyContent: 'center', marginBottom: 2, overflow: 'hidden',
  },
  shopItemName: { fontSize: 12.5, fontWeight: 700, color: '#dcdce2', lineHeight: 1.25, minHeight: 32 },
  shopItemBonus: { fontSize: 10, color: '#7a7a82', lineHeight: 1.25 },
