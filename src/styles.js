...
export const styles = {
  ...
  healthBarsWrap: { display: 'flex', flexDirection: 'column', gap: 10, marginTop: 14 },
  healthBarItem: {},
  ...
  healthBarTrack: { height: 11, background: '#1a1a20', borderRadius: 6, overflow: 'hidden', border: '1px solid #2a2a32' },
  healthBarFill: { height: '100%', borderRadius: 6, transition: 'width 0.4s ease' },
  healthDebuffsWrap: { display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 6, marginTop: 2 },
  debuffBadge: {
