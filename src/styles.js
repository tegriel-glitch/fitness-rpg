...
export const styles = {
  ...
  healthBarsMergedWrap: { marginTop: 14, display: 'flex', flexDirection: 'column', gap: 4 },
  healthBarItem: {},
  ...
  healthBarTrack: {
    position: 'relative', height: 10, background: '#1a1a20', borderRadius: 4,
    overflow: 'hidden', border: '1px solid rgba(0,0,0,0.4)',
  },
  healthBarFill: { height: '100%', borderRadius: 4, transition: 'width 0.4s ease' },
