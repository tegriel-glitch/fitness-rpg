...
export default function App() {
  ...
  async function selectNickname(nick) {
    ...
    try {
      ...
      if (row.character_name)               setCharacterName(row.character_name);
...
function GuildView({ playerName, playerLevel, playerClass, playerPhysical, playerMental, playerTitleEntry, activeTitle, earnedTitles, raids, guildLikes, onLike, lockedClassId, chosenPathId, guildMembers, onRefreshGuild }) {
