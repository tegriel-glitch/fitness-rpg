...
// ---------- AVATAR ICONS ----------
// SVG-based RPG/fantasy avatar icons. renderAvatarContent uses .svg field to draw inline SVG.
// Groups: classes, weapons, elements, beasts, arcane
...
const AVATAR_EMOJIS = [
  // ── КЛАССЫ ──────────────────────────────────────────
  {
    id: 'hood', name: 'Капюшон следопыта', group: 'Классы',
    svg: (<>
      <ellipse cx="50" cy="42" rx="28" ry="30" fill="#5d4037"/>
      <path d="M22 55 Q50 30 78 55 Q70 35 50 28 Q30 35 22 55Z" fill="#3e2723"/>
      <ellipse cx="50" cy="58" rx="22" ry="18" fill="#6d4c41"/>
      <circle cx="50" cy="55" r="13" fill="#4a3728"/>
      <path d="M38 60 Q50 52 62 60" fill="none" stroke="#795548" strokeWidth="2"/>
      <circle cx="44" cy="54" r="3" fill="#ffd54f" opacity="0.85"/>
      <circle cx="56" cy="54" r="3" fill="#ffd54f" opacity="0.85"/>
    </>),
  },
  {
    id: 'berserker_helm', name: 'Шлем берсерка', group: 'Классы',
    svg: (<>
      <path d="M20 65 L25 40 Q50 18 75 40 L80 65 Q65 75 50 76 Q35 75 20 65Z" fill="#b71c1c"/>
      <path d="M25 40 Q50 22 75 40 L72 45 Q50 28 28 45Z" fill="#e53935"/>
      <rect x="38" y="62" width="24" height="10" rx="3" fill="#c62828"/>
      <path d="M20 55 L10 45 L18 42Z" fill="#ef5350"/>
      <path d="M80 55 L90 45 L82 42Z" fill="#ef5350"/>
      <rect x="34" y="50" width="32" height="7" rx="2" fill="#b71c1c"/>
      <rect x="42" y="50" width="16" height="7" fill="#1a1a1a" opacity="0.5"/>
    </>),
  },
  {
    id: 'prayer_beads', name: 'Чётки монаха', group: 'Классы',
    svg: (<>
      <circle cx="50" cy="50" r="32" fill="none" stroke="#8d6e63" strokeWidth="3" strokeDasharray="6 4"/>
      {[0,45,90,135,180,225,270,315].map((deg, i) => {
        const r = 32, rad = deg * Math.PI / 180;
        const x = 50 + r * Math.cos(rad), y = 50 + r * Math.sin(rad);
        return <circle key={i} cx={x} cy={y} r="6" fill={i === 0 ? "#ffd54f" : "#a1887f"} stroke="#6d4c41" strokeWidth="1.5"/>;
      })}
      <circle cx="50" cy="50" r="10" fill="#ff8f00" stroke="#e65100" strokeWidth="2"/>
      <path d="M45 50 L50 44 L55 50 L50 56Z" fill="#fff9c4" opacity="0.85"/>
    </>),
  },
  {
    id: 'spirit_mask', name: 'Маска шамана', group: 'Классы',
    svg: (<>
      <ellipse cx="50" cy="52" rx="28" ry="32" fill="#1a237e"/>
      <path d="M22 52 Q50 20 78 52" fill="#283593"/>
      <ellipse cx="39" cy="50" rx="8" ry="10" fill="#0d47a1"/>
      <ellipse cx="61" cy="50" rx="8" ry="10" fill="#0d47a1"/>
      <ellipse cx="39" cy="50" rx="5" ry="6" fill="#80deea" opacity="0.9"/>
      <ellipse cx="61" cy="50" rx="5" ry="6" fill="#80deea" opacity="0.9"/>
      <circle cx="39" cy="50" r="2" fill="#e3f2fd"/>
      <circle cx="61" cy="50" r="2" fill="#e3f2fd"/>
      <path d="M36 66 Q50 72 64 66" fill="none" stroke="#7986cb" strokeWidth="2.5"/>
      <path d="M44 24 L50 14 L56 24" fill="none" stroke="#ffd54f" strokeWidth="2.5"/>
      <circle cx="50" cy="12" r="4" fill="#ffd54f"/>
    </>),
  },
  {
    id: 'archmage_hat', name: 'Шляпа архимага', group: 'Классы',
    svg: (<>
      <ellipse cx="50" cy="72" rx="34" ry="10" fill="#4a148c"/>
      <path d="M16 72 L35 25 L50 8 L65 25 L84 72Z" fill="#6a1b9a"/>
      <path d="M35 25 L65 25 L84 72 L16 72Z" fill="#7b1fa2"/>
      <ellipse cx="50" cy="72" rx="34" ry="10" fill="none" stroke="#ce93d8" strokeWidth="2"/>
      <path d="M36 28 Q50 20 64 28" fill="none" stroke="#ffd54f" strokeWidth="2"/>
      <circle cx="50" cy="8" r="5" fill="#ffd54f"/>
      <path d="M50 13 L50 22" stroke="#ffd54f" strokeWidth="2"/>
      <circle cx="35" cy="52" r="3" fill="#e040fb" opacity="0.8"/>
      <circle cx="65" cy="52" r="3" fill="#e040fb" opacity="0.8"/>
    </>),
  },
  {
    id: 'mace', name: 'Булава мастера', group: 'Классы',
    svg: (<>
      <rect x="46" y="55" width="8" height="38" rx="4" fill="#78909c"/>
      <rect x="43" y="50" width="14" height="6" rx="2" fill="#546e7a"/>
      <circle cx="50" cy="34" r="18" fill="#455a64"/>
      {[0,45,90,135,180,225,270,315].map((deg, i) => {
        const rad = deg * Math.PI / 180;
        const x = 50 + 18 * Math.cos(rad), y = 34 + 18 * Math.sin(rad);
        return <path key={i} d={`M${x} ${y} L${50+22*Math.cos(rad)} ${34+22*Math.sin(rad)}`} stroke="#b0bec5" strokeWidth="5" strokeLinecap="round"/>;
      })}
      <circle cx="50" cy="34" r="10" fill="#607d8b"/>
      <circle cx="50" cy="34" r="5" fill="#90a4ae"/>
    </>),
  },
  // ── ОРУЖИЕ ──────────────────────────────────────────
  {
    id: 'longsword', name: 'Длинный меч', group: 'Оружие',
    svg: (<>
      <rect x="48" y="10" width="4" height="58" rx="2" fill="#bdbdbd"/>
      <path d="M48 10 L50 5 L52 10Z" fill="#e0e0e0"/>
      <rect x="35" y="63" width="30" height="6" rx="3" fill="#c9a227"/>
      <rect x="47" y="69" width="6" height="22" rx="3" fill="#8d6e63"/>
      <path d="M48 10 L46 30 L48 68 L52 68 L54 30 L52 10Z" fill="none" stroke="#9e9e9e" strokeWidth="1"/>
      <path d="M48 14 L52 14 M48 28 L52 28 M48 42 L52 42 M48 56 L52 56" stroke="#e0e0e0" strokeWidth="1" opacity="0.6"/>
    </>),
  },
  {
    id: 'dagger_rune', name: 'Руническй кинжал', group: 'Оружие',
    svg: (<>
      <path d="M50 8 L55 25 L52 75 L48 75 L45 25Z" fill="#b0bec5"/>
      <path d="M50 8 L52 25 L50 15Z" fill="#eceff1"/>
      <path d="M50 8 L48 25 L50 15Z" fill="#78909c"/>
      <rect x="40" y="70" width="20" height="5" rx="2" fill="#8d6e63"/>
      <rect x="44" y="75" width="12" height="18" rx="3" fill="#6d4c41"/>
      <path d="M48 30 L52 30 M48 42 L52 42 M48 54 L52 54" stroke="#4fc3f7" strokeWidth="2" strokeLinecap="round"/>
      <circle cx="50" cy="24" r="3" fill="#4fc3f7" opacity="0.9"/>
    </>),
  },
  {
    id: 'bow', name: 'Лук следопыта', group: 'Оружие',
    svg: (<>
      <path d="M28 15 Q12 50 28 85" fill="none" stroke="#8d6e63" strokeWidth="5" strokeLinecap="round"/>
      <path d="M28 15 L28 85" stroke="#c9a227" strokeWidth="1.5" strokeDasharray="3 3"/>
      <line x1="28" y1="50" x2="75" y2="50" stroke="#ffd54f" strokeWidth="2"/>
      <path d="M65 44 L75 50 L65 56" fill="none" stroke="#ffd54f" strokeWidth="2"/>
      <path d="M27 15 Q24 50 27 85" fill="none" stroke="#a1887f" strokeWidth="2"/>
    </>),
  },
  {
    id: 'staff_arcane', name: 'Аркановый посох', group: 'Оружие',
    svg: (<>
      <rect x="47" y="28" width="6" height="70" rx="3" fill="#5d4037"/>
      <path d="M50 5 L60 18 L55 20 L62 28 L38 28 L45 20 L40 18Z" fill="#7b1fa2"/>
      <circle cx="50" cy="16" r="8" fill="#ab47bc"/>
      <circle cx="50" cy="16" r="5" fill="#ce93d8"/>
      <circle cx="50" cy="16" r="2" fill="#f3e5f5"/>
      <path d="M42 28 L38 38 M58 28 L62 38" stroke="#9c27b0" strokeWidth="2" strokeLinecap="round"/>
      <circle cx="38" cy="40" r="3" fill="#e040fb" opacity="0.8"/>
      <circle cx="62" cy="40" r="3" fill="#e040fb" opacity="0.8"/>
    </>),
  },
  {
    id: 'axe_battle', name: 'Боевой топор', group: 'Оружие',
    svg: (<>
      <rect x="47" y="42" width="6" height="50" rx="3" fill="#795548"/>
      <path d="M50 8 L72 20 L68 42 L50 42 L32 42 L28 20Z" fill="#ef5350"/>
      <path d="M50 8 L66 18 L63 38 L50 38Z" fill="#e53935"/>
      <path d="M50 8 L34 18 L37 38 L50 38Z" fill="#c62828"/>
      <path d="M50 8 L50 42" stroke="#b71c1c" strokeWidth="2"/>
      <path d="M36 30 Q50 22 64 30" fill="none" stroke="#ff8a80" strokeWidth="2" opacity="0.7"/>
    </>),
  },
  {
    id: 'shield_knight', name: 'Рыцарский щит', group: 'Оружие',
    svg: (<>
      <path d="M50 10 L78 22 L78 55 Q78 80 50 92 Q22 80 22 55 L22 22Z" fill="#1565c0"/>
      <path d="M50 10 L72 20 L72 54 Q72 76 50 86 Q28 76 28 54 L28 20Z" fill="#1976d2"/>
      <path d="M50 20 L50 80 M30 50 L70 50" stroke="#fdd835" strokeWidth="3" opacity="0.9"/>
      <path d="M38 38 L50 26 L62 38 L50 50Z" fill="#fdd835" opacity="0.85"/>
    </>),
  },
  // ── СТИХИИ ──────────────────────────────────────────
  {
    id: 'fire_elem', name: 'Пламя', group: 'Стихии',
    svg: (<>
      <path d="M50 88 Q28 75 28 52 Q28 32 40 20 Q38 38 50 42 Q46 28 52 15 Q62 28 60 42 Q72 36 70 20 Q82 35 72 55 Q72 75 50 88Z" fill="#ff6f00"/>
      <path d="M50 85 Q35 72 35 55 Q35 42 44 32 Q42 46 50 50 Q48 38 52 28 Q60 40 58 52 Q64 46 62 32 Q72 45 65 60 Q65 75 50 85Z" fill="#ffa000"/>
      <path d="M50 80 Q40 68 40 56 Q40 47 48 40 Q46 52 50 55 Q54 48 52 38 Q58 48 56 58 Q60 52 58 40 Q66 52 60 62 Q60 72 50 80Z" fill="#ffca28"/>
      <ellipse cx="50" cy="68" rx="10" ry="8" fill="#fff9c4" opacity="0.5"/>
    </>),
  },
  {
    id: 'ice_elem', name: 'Лёд', group: 'Стихии',
    svg: (<>
      <line x1="50" y1="10" x2="50" y2="90" stroke="#80deea" strokeWidth="4" strokeLinecap="round"/>
      <line x1="10" y1="50" x2="90" y2="50" stroke="#80deea" strokeWidth="4" strokeLinecap="round"/>
      <line x1="22" y1="22" x2="78" y2="78" stroke="#80deea" strokeWidth="4" strokeLinecap="round"/>
      <line x1="78" y1="22" x2="22" y2="78" stroke="#80deea" strokeWidth="4" strokeLinecap="round"/>
      {[[50,10],[50,90],[10,50],[90,50],[22,22],[78,78],[78,22],[22,78]].map(([x,y],i) =>
        <path key={i} d={`M${x-6} ${y} L${x} ${y-8} L${x+6} ${y} L${x} ${y+8}Z`} fill="#e0f7fa" opacity="0.9"/>
      )}
      <circle cx="50" cy="50" r="10" fill="#b2ebf2" stroke="#e0f7fa" strokeWidth="2"/>
      <circle cx="50" cy="50" r="4" fill="#fff"/>
    </>),
  },
  {
    id: 'lightning_elem', name: 'Молния', group: 'Стихии',
    svg: (<>
      <path d="M58 5 L30 52 L48 52 L42 95 L70 48 L52 48Z" fill="#fdd835"/>
      <path d="M58 5 L34 52 L50 52 L44 95 L68 50 L52 50Z" fill="#ffee58"/>
      <path d="M58 5 L38 50 L52 50 L46 93" fill="none" stroke="#fff9c4" strokeWidth="2" opacity="0.7"/>
    </>),
  },
  {
    id: 'wind_elem', name: 'Ветер', group: 'Стихии',
    svg: (<>
      <path d="M15 35 Q40 20 65 35 Q80 42 75 52 Q70 62 55 58 Q45 55 50 45" fill="none" stroke="#b2dfdb" strokeWidth="4" strokeLinecap="round"/>
      <path d="M10 55 Q35 40 60 55 Q75 62 70 72 Q65 80 50 76 Q42 73 45 65" fill="none" stroke="#80cbc4" strokeWidth="4" strokeLinecap="round"/>
      <path d="M20 72 Q42 60 65 72 Q76 79 72 87 Q66 93 55 90" fill="none" stroke="#4db6ac" strokeWidth="4" strokeLinecap="round"/>
      <path d="M65 35 L75 30 L78 38Z" fill="#b2dfdb"/>
      <path d="M70 72 L80 67 L82 76Z" fill="#80cbc4"/>
    </>),
  },
  {
    id: 'earth_elem', name: 'Земля', group: 'Стихии',
    svg: (<>
      <polygon points="50,12 88,88 12,88" fill="#6d4c41" opacity="0.9"/>
      <polygon points="50,22 80,82 20,82" fill="#795548"/>
      <polygon points="50,35 70,75 30,75" fill="#8d6e63"/>
      <polygon points="50,48 62,70 38,70" fill="#a1887f"/>
      <circle cx="50" cy="60" r="7" fill="#d7ccc8"/>
      <circle cx="50" cy="60" r="3.5" fill="#fff8f6"/>
    </>),
  },
  {
    id: 'shadow_elem', name: 'Тень', group: 'Стихии',
    svg: (<>
      <circle cx="50" cy="50" r="36" fill="#1a1a2e" opacity="0.95"/>
      <circle cx="50" cy="50" r="28" fill="#16213e"/>
      <path d="M50 22 Q60 36 78 50 Q60 64 50 78 Q40 64 22 50 Q40 36 50 22Z" fill="#0f3460" opacity="0.9"/>
      <circle cx="50" cy="50" r="10" fill="#533483"/>
      <circle cx="50" cy="50" r="5" fill="#8b5cf6" opacity="0.9"/>
      <circle cx="50" cy="50" r="2" fill="#c4b5fd"/>
      {[0,60,120,180,240,300].map((d,i) => {
        const r=28, rad=d*Math.PI/180;
        return <circle key={i} cx={50+r*Math.cos(rad)} cy={50+r*Math.sin(rad)} r="2.5" fill="#8b5cf6" opacity="0.7"/>;
      })}
    </>),
  },
  // ── ЗВЕРИ ──────────────────────────────────────────
  {
    id: 'wolf_beast', name: 'Волк', group: 'Звери',
    svg: (<>
      <ellipse cx="50" cy="62" rx="26" ry="22" fill="#607d8b"/>
      <ellipse cx="50" cy="62" rx="20" ry="16" fill="#78909c"/>
      <ellipse cx="50" cy="52" rx="22" ry="20" fill="#546e7a"/>
      <polygon points="35,40 30,18 42,35" fill="#546e7a"/>
      <polygon points="65,40 70,18 58,35" fill="#546e7a"/>
      <polygon points="36,40 32,22 41,36" fill="#f8bbd0" opacity="0.7"/>
      <polygon points="64,40 68,22 59,36" fill="#f8bbd0" opacity="0.7"/>
      <circle cx="42" cy="50" r="5" fill="#263238"/>
      <circle cx="58" cy="50" r="5" fill="#263238"/>
      <circle cx="43" cy="49" r="2" fill="#fff" opacity="0.8"/>
      <circle cx="59" cy="49" r="2" fill="#fff" opacity="0.8"/>
      <path d="M42 63 Q50 68 58 63" fill="none" stroke="#263238" strokeWidth="2"/>
      <ellipse cx="50" cy="67" rx="6" ry="4" fill="#90a4ae"/>
    </>),
  },
  {
    id: 'dragon_beast', name: 'Дракон', group: 'Звери',
    svg: (<>
      <ellipse cx="50" cy="60" rx="28" ry="24" fill="#1b5e20"/>
      <ellipse cx="50" cy="55" rx="22" ry="20" fill="#2e7d32"/>
      <ellipse cx="50" cy="48" rx="18" ry="16" fill="#388e3c"/>
      <path d="M32 42 Q20 30 15 18 Q28 25 35 40Z" fill="#1b5e20"/>
      <path d="M68 42 Q80 30 85 18 Q72 25 65 40Z" fill="#1b5e20"/>
      <circle cx="42" cy="45" r="5" fill="#f9a825"/>
      <circle cx="58" cy="45" r="5" fill="#f9a825"/>
      <circle cx="42" cy="46" r="2.5" fill="#1a1a1a"/>
      <circle cx="58" cy="46" r="2.5" fill="#1a1a1a"/>
      <path d="M44 58 L50 54 L56 58" fill="#ef9a9a" opacity="0.7"/>
      <path d="M40 36 L50 22 L60 36" fill="#1b5e20"/>
      <circle cx="50" cy="20" r="5" fill="#4caf50" opacity="0.8"/>
    </>),
  },
  {
    id: 'phoenix_beast', name: 'Феникс', group: 'Звери',
    svg: (<>
      <path d="M50 88 Q30 70 20 50 Q25 58 38 58 Q22 42 25 20 Q38 38 42 55 Q50 40 50 15 Q58 40 58 55 Q62 38 75 20 Q78 42 62 58 Q75 58 80 50 Q70 70 50 88Z" fill="#e65100"/>
      <path d="M50 85 Q33 68 24 50 Q30 56 40 56 Q26 42 28 24 Q40 40 44 56 Q50 42 50 20 Q56 42 56 56 Q60 40 72 24 Q74 42 60 56 Q70 56 76 50 Q67 68 50 85Z" fill="#f4511e"/>
      <path d="M50 80 Q36 65 30 50 Q36 56 44 54 Q34 42 36 28 Q44 42 46 56 Q50 45 50 25 Q54 45 54 56 Q56 42 64 28 Q66 42 56 54 Q64 56 70 50 Q64 65 50 80Z" fill="#ff7043"/>
      <ellipse cx="50" cy="60" rx="10" ry="6" fill="#ffd54f" opacity="0.8"/>
      <circle cx="50" cy="50" r="7" fill="#ffca28"/>
      <circle cx="50" cy="50" r="3" fill="#fff9c4"/>
    </>),
  },
  {
    id: 'serpent_beast', name: 'Змей', group: 'Звери',
    svg: (<>
      <path d="M25 80 Q15 60 25 45 Q35 30 50 35 Q65 40 70 25 Q80 10 88 20 Q85 32 75 30 Q62 28 55 42 Q48 56 60 68 Q70 78 65 90 Q55 95 50 85 Q42 75 25 80Z" fill="#388e3c"/>
      <path d="M25 80 Q18 62 28 47 Q38 34 50 38 Q63 43 68 28 Q76 15 84 22" fill="none" stroke="#4caf50" strokeWidth="3"/>
      <ellipse cx="86" cy="20" rx="8" ry="6" fill="#2e7d32" transform="rotate(-20 86 20)"/>
      <ellipse cx="86" cy="20" rx="4" ry="3" fill="#1b5e20" transform="rotate(-20 86 20)"/>
      <circle cx="84" cy="17" r="2" fill="#f9a825" transform="rotate(-20 84 17)"/>
      <path d="M90 20 L96 17 M90 22 L96 25" stroke="#ef5350" strokeWidth="2" strokeLinecap="round"/>
    </>),
  },
  {
    id: 'bear_beast', name: 'Медведь', group: 'Звери',
    svg: (<>
      <ellipse cx="50" cy="62" rx="30" ry="26" fill="#4e342e"/>
      <ellipse cx="50" cy="58" rx="24" ry="22" fill="#5d4037"/>
      <ellipse cx="50" cy="50" rx="20" ry="18" fill="#6d4c41"/>
      <circle cx="34" cy="32" r="12" fill="#4e342e"/>
      <circle cx="66" cy="32" r="12" fill="#4e342e"/>
      <circle cx="34" cy="32" r="7" fill="#5d4037"/>
      <circle cx="66" cy="32" r="7" fill="#5d4037"/>
      <circle cx="43" cy="48" r="5" fill="#212121"/>
      <circle cx="57" cy="48" r="5" fill="#212121"/>
      <circle cx="44" cy="47" r="2" fill="#fff" opacity="0.7"/>
      <circle cx="58" cy="47" r="2" fill="#fff" opacity="0.7"/>
      <ellipse cx="50" cy="60" rx="8" ry="6" fill="#8d6e63"/>
      <path d="M43 66 Q50 72 57 66" fill="none" stroke="#3e2723" strokeWidth="2"/>
    </>),
  },
  {
    id: 'raven_beast', name: 'Ворон', group: 'Звери',
    svg: (<>
      <ellipse cx="50" cy="55" rx="24" ry="28" fill="#1a1a2e"/>
      <ellipse cx="50" cy="50" rx="20" ry="22" fill="#212135"/>
      <path d="M26 50 Q18 40 14 28 Q25 35 30 48Z" fill="#1a1a2e"/>
      <path d="M74 50 Q82 40 86 28 Q75 35 70 48Z" fill="#1a1a2e"/>
      <circle cx="41" cy="44" r="5" fill="#37474f"/>
      <circle cx="59" cy="44" r="5" fill="#37474f"/>
      <circle cx="41" cy="44" r="3" fill="#00e5ff" opacity="0.9"/>
      <circle cx="59" cy="44" r="3" fill="#00e5ff" opacity="0.9"/>
      <circle cx="41" cy="44" r="1.5" fill="#fff"/>
      <circle cx="59" cy="44" r="1.5" fill="#fff"/>
      <path d="M44 58 L50 53 L56 58 L50 65Z" fill="#455a64"/>
      <path d="M50 53 L50 65" stroke="#546e7a" strokeWidth="1.5"/>
    </>),
  },
  // ── АРКАН / МИСТИКА ──────────────────────────────────────────
  {
    id: 'crystal_ball', name: 'Хрустальный шар', group: 'Аркан',
    svg: (<>
      <circle cx="50" cy="48" r="32" fill="#e3f2fd" opacity="0.3"/>
      <circle cx="50" cy="48" r="28" fill="#bbdefb" opacity="0.4"/>
      <circle cx="50" cy="48" r="22" fill="#90caf9" opacity="0.5"/>
      <circle cx="50" cy="48" r="15" fill="#64b5f6" opacity="0.7"/>
      <circle cx="50" cy="48" r="8" fill="#42a5f5" opacity="0.9"/>
      <circle cx="44" cy="40" r="5" fill="#fff" opacity="0.6"/>
      <circle cx="42" cy="38" r="2.5" fill="#fff" opacity="0.8"/>
      <ellipse cx="50" cy="82" rx="20" ry="5" fill="#0d47a1" opacity="0.5"/>
      <path d="M38 82 L30 88 L70 88 L62 82Z" fill="#0d47a1" opacity="0.3"/>
    </>),
  },
  {
    id: 'eye_arcane', name: 'Всевидящее око', group: 'Аркан',
    svg: (<>
      <path d="M10 50 Q30 20 50 18 Q70 20 90 50 Q70 80 50 82 Q30 80 10 50Z" fill="#1a237e"/>
      <path d="M15 50 Q32 26 50 24 Q68 26 85 50 Q68 74 50 76 Q32 74 15 50Z" fill="#283593"/>
      <circle cx="50" cy="50" r="20" fill="#0d47a1"/>
      <circle cx="50" cy="50" r="14" fill="#1565c0"/>
      <circle cx="50" cy="50" r="8" fill="#0d1b6e"/>
      <circle cx="50" cy="50" r="4" fill="#000"/>
      <circle cx="46" cy="46" r="2.5" fill="#fff" opacity="0.7"/>
      {[0,40,80,120,160,200,240,280,320].map((d,i)=>{
        const rad=d*Math.PI/180;
        return <line key={i} x1={50+14*Math.cos(rad)} y1={50+14*Math.sin(rad)} x2={50+20*Math.cos(rad)} y2={50+20*Math.sin(rad)} stroke="#ffd54f" strokeWidth="1.5" opacity="0.7"/>;
      })}
    </>),
  },
  {
    id: 'rune_stone', name: 'Руна силы', group: 'Аркан',
    svg: (<>
      <rect x="18" y="18" width="64" height="64" rx="10" fill="#37474f"/>
      <rect x="22" y="22" width="56" height="56" rx="8" fill="#455a64"/>
      <path d="M38 30 L38 70 M62 30 L62 70 M38 50 L62 50 M38 30 L62 30 M38 70 L62 70" stroke="#4fc3f7" strokeWidth="3" strokeLinecap="round"/>
      <path d="M38 30 L50 20 L62 30" fill="none" stroke="#4fc3f7" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="50" cy="50" r="4" fill="#4fc3f7" opacity="0.9"/>
      <circle cx="38" cy="30" r="3" fill="#81d4fa"/>
      <circle cx="62" cy="30" r="3" fill="#81d4fa"/>
      <circle cx="38" cy="70" r="3" fill="#81d4fa"/>
      <circle cx="62" cy="70" r="3" fill="#81d4fa"/>
    </>),
  },
  {
    id: 'potion', name: 'Зелье силы', group: 'Аркан',
    svg: (<>
      <path d="M38 30 L38 20 L62 20 L62 30 Q75 40 75 60 Q75 82 50 84 Q25 82 25 60 Q25 40 38 30Z" fill="#1a237e"/>
      <path d="M40 32 L40 22 L60 22 L60 32 Q72 42 72 60 Q72 78 50 80 Q28 78 28 60 Q28 42 40 32Z" fill="#283593"/>
      <path d="M40 58 Q50 48 60 58 Q60 72 50 74 Q40 72 40 58Z" fill="#7c4dff" opacity="0.9"/>
      <circle cx="40" cy="48" r="4" fill="#b39ddb" opacity="0.6"/>
      <circle cx="58" cy="52" r="3" fill="#b39ddb" opacity="0.4"/>
      <rect x="40" y="18" width="20" height="5" rx="2" fill="#455a64"/>
      <rect x="44" y="13" width="12" height="7" rx="2" fill="#546e7a"/>
      <path d="M28 60 Q38 72 50 72 Q62 72 72 60" fill="none" stroke="#9575cd" strokeWidth="1.5" opacity="0.5"/>
    </>),
  },
  {
    id: 'scroll', name: 'Свиток знания', group: 'Аркан',
    svg: (<>
      <path d="M20 20 Q20 12 28 12 L72 12 Q80 12 80 20 L80 80 Q80 88 72 88 L28 88 Q20 88 20 80Z" fill="#efebe9"/>
      <path d="M28 12 Q20 12 20 20 L20 80 Q20 88 28 88 Q20 88 20 80 L20 20 Q20 12 28 12Z" fill="#d7ccc8"/>
      <path d="M72 12 Q80 12 80 20 L80 80 Q80 88 72 88 Q80 88 80 80 L80 20 Q80 12 72 12Z" fill="#d7ccc8"/>
      <path d="M32 30 L68 30 M32 40 L68 40 M32 50 L68 50 M32 60 L65 60 M32 70 L60 70" stroke="#8d6e63" strokeWidth="2" strokeLinecap="round" opacity="0.7"/>
      <path d="M38 36 L42 34 L44 38 L40 40Z" fill="#e65100" opacity="0.6"/>
      <circle cx="50" cy="20" r="5" fill="#c62828" opacity="0.8"/>
    </>),
  },
  {
    id: 'crown_arcane', name: 'Корона владыки', group: 'Аркан',
    svg: (<>
      <path d="M15 75 L20 40 L35 60 L50 15 L65 60 L80 40 L85 75Z" fill="#f9a825"/>
      <path d="M15 75 L85 75 L80 82 L20 82Z" fill="#f57f17"/>
      <circle cx="50" cy="15" r="7" fill="#e53935"/>
      <circle cx="20" cy="40" r="5" fill="#1565c0"/>
      <circle cx="80" cy="40" r="5" fill="#1565c0"/>
      <circle cx="35" cy="60" r="4" fill="#2e7d32"/>
      <circle cx="65" cy="60" r="4" fill="#2e7d32"/>
      <path d="M20 75 L80 75" stroke="#fff9c4" strokeWidth="2" opacity="0.6"/>
    </>),
  },
  {
    id: 'gem_arcane', name: 'Камень душ', group: 'Аркан',
    svg: (<>
      <polygon points="50,10 72,30 72,70 50,90 28,70 28,30" fill="#880e4f"/>
      <polygon points="50,10 66,28 66,72 50,90 34,72 34,28" fill="#ad1457"/>
      <polygon points="50,10 62,26 62,74 50,90 38,74 38,26" fill="#c2185b"/>
      <polygon points="50,10 58,24 58,76 50,90 42,76 42,24" fill="#e91e63"/>
      <polygon points="50,18 55,30 55,70 50,82 45,70 45,30" fill="#f48fb1" opacity="0.6"/>
      <polygon points="50,18 52,28 52,50 50,58" fill="#fff" opacity="0.4"/>
      {[0,60,120,180,240,300].map((d,i)=>{
        const rad=d*Math.PI/180, r=40;
        const x=50+r*Math.cos(rad), y=50+r*Math.sin(rad);
        return <circle key={i} cx={x} cy={y} r="2" fill="#f48fb1" opacity="0.5"/>;
      })}
    </>),
  },
];
...
export default function App() {
  ...
  const statTotals = useMemo(() => {
    ...
    sortedAsc.forEach((log) => {
      ...
      let xpForThisLog = blocked ? 0 : base * multiplier * classBonus * shopBonus * weeklyTrainingBonus * ritualBonus * challengeBuffMult * challengeDebuffMult;
    ...
    return totals;
  }, [logs, healthState.poisonPenaltyEvents, healthState.xpBlockedByDate, comboResults.totalRewards, balanceResults.totalRewards, mythicAchievementsEvaluated, pentaResults.legendXpPerStat, pentaResults.godUnlocked, equippedShopItems, raids, books, lockedClassId, secretAchievementsEvaluated, morningRitualLog, challengeState]);
  ...
  const challengeProgress = useMemo(() => {
    ...
    const isFailed = missedSoFar > maxAllowed;
    const isComplete = elapsed >= def.duration && !isFailed &&
    ...
    return { def, dayResults, elapsed, missedSoFar, maxAllowed, isFailed, isComplete, perfectDays };
  }, [challengeState.active, logs]);
  ...
  function addRaidContribution(bossId, participantName, value, override = false) {
    ...
    // If override mode: remove all of this player's contributions for today, then add new one
    const baseContribs = override
      ? raid.contributions.filter(c => !(c.participantName === participantName && c.date === today))
      : raid.contributions;
    const newContribs = [...baseContribs, newContrib];
    let victory = false;
...
function Header({ levelState, unlockedCount, totalAchievements, achievements, mythicAchievements, pentaResults, comboCounts, balanceCounts, secretAchievements, receivedLikes, activeShield, ritualXpBonus, morningRitualLog, nudges, onDismissNudges, name, onNameChange, healthState, currentClass, currencyBalance, activeTitle, earnedTitles, lockedClassId, chosenPathId, logs, streaksByActivity, equippedShopItems, equippedAvatarFrame, avatarEmoji, onSelectAvatarEmoji, activeChallengeBuff, challengeFailDebuff }) {
  ...
  return (
    <div style={styles.header}>
          ...
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', zIndex: 60, display: 'flex', alignItems: 'flex-end', justifyContent: 'center', padding: '0 0 0 0' }}
            ...
            <div style={{ background: '#1c1c22', border: '1.5px solid #2c2c34', borderRadius: '20px 20px 0 0', width: '100%', maxWidth: 420, maxHeight: '80vh', overflow: 'hidden', display: 'flex', flexDirection: 'column', animation: 'fadeUp 0.2s ease' }}
              ...
              <div style={{ overflowY: 'auto', padding: '12px 14px 24px', flex: 1 }}>
                {['Классы', 'Оружие', 'Стихии', 'Звери', 'Аркан'].map(group => {
                        ...
                        {groupAvatars.map(av => {
                          ...
                          return (
                            <button key={av.id} onClick={() => { onSelectAvatarEmoji(av.id); setShowAvatarPicker(false); }}
                              ...
                              <AvatarSvg svgContent={av.svg} size={38} />
      ...
      {(activeShield || ritualXpBonus > 0 || activeChallengeBuff || challengeFailDebuff) && (
      ...
      {status === 'active' && (
        <>
          ...
          {isParticipant && (() => {
            ...
            const myTodayTotal = myToday.reduce((s, c) => s + c.value, 0);
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
                  <div style={{ fontSize: 11, color: '#7a7a82' }}>
                    {roleDef
                      ...
                      : `Внести вклад (${boss.condition.unit}):`}
                  </div>
                  {myTodayTotal > 0 && (
                    <button
                      onClick={() => setOverrideMode(!overrideMode)}
                      title="Перезаписать вклад за сегодня"
                      style={{
                        fontSize: 10, padding: '2px 7px', borderRadius: 5, cursor: 'pointer', fontWeight: 700,
                        background: overrideMode ? '#4a1a1a' : 'none',
                        border: `1px solid ${overrideMode ? '#e05f4a' : '#3a3a42'}`,
                        color: overrideMode ? '#e05f4a' : '#5a5a6a',
                      }}
                    >
                      ✎ Перезаписать ({myTodayTotal} {boss.condition.unit})
                    </button>
                  )}
                </div>
                {overrideMode && (
                  <div style={{ fontSize: 10.5, color: '#e09060', background: '#2a1a10', border: '1px solid #5a3020', borderRadius: 6, padding: '5px 8px', marginBottom: 6 }}>
                    Старый вклад за сегодня будет заменён новым значением
                  </div>
                )}
                <div style={{ display: 'flex', gap: 8 }}>
                  <input
                    type="number"
                    placeholder={overrideMode ? `Новое значение ${boss.condition.unit}...` : `Введи ${boss.condition.unit}...`}
                    value={contribValue}
                    onChange={e => setContribValue(e.target.value)}
                    style={{ flex: 1, background: '#13131a', border: `1px solid ${overrideMode ? '#e05f4a55' : rc.border}`, borderRadius: 8, padding: '8px 10px', color: '#d0d0da', fontSize: 12, outline: 'none', fontFamily: 'inherit' }}
                  />
...
function CharacterView({ statTotals, currentClass, equippedShopItems, purchasedItemIds, onEquip, earnedTitles, activeTitle, setActiveTitle, titleCooldownDays, levelState, lockedClassId, chosenPathId, achievementsEvaluated, purchasedFrameIds, equippedAvatarFrame, onEquipFrame, avatarEmoji, onSelectAvatarEmoji }) {
...
function renderAvatarContent(avatarEmoji, titleText, clsComponent, clsColor, size = 24) {
  if (avatarEmoji) {
    ...
    if (found) return <AvatarSvg svgContent={found.svg} size={size * 1.5} />;
  }
        ...
        {sorted.map((member) => {
          ...
          return (
            ...
            >
              ...
              {/* Active raid progress block */}
              {member.raidIds && member.raidIds.length > 0 && member.raidIds.map(rId => {
                const boss = RAID_BOSSES.find(b => b.id === rId);
                const raid = raids[rId];
                if (!boss || !raid) return null;
                const rc = RAID_RARITY_COLORS[boss.rarity]?.color || '#e05f9c';
                const rBg = RAID_RARITY_COLORS[boss.rarity]?.bg || '#1a1228';
                const rBorder = RAID_RARITY_COLORS[boss.rarity]?.border || '#3d1f5c';
                const stats = computeRaidStats(boss, raid);

                // Дней осталось
                const startD = raid.startDate ? new Date(raid.startDate) : null;
                const daysLeft = startD
                  ? Math.max(0, boss.durationDays - Math.floor((Date.now() - startD.getTime()) / 86400000))
                  : boss.durationDays;

                // Форматирование числа (округляем до 1 знака если дробное)
                const fmt = v => Number.isInteger(v) ? v : +v.toFixed(1);

                return (
                  <div key={rId} style={{
                    marginBottom: 10, padding: '10px 12px',
                    background: rBg, border: `1px solid ${rBorder}`,
                    borderRadius: 10,
                  }}>
                    {/* Boss header */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 8 }}>
                      <span style={{ fontSize: 18 }}>{boss.creature}</span>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 11, fontWeight: 800, color: rc, letterSpacing: 0.3 }}>
                          {boss.name}
                        </div>
                        <div style={{ fontSize: 9.5, color: '#5a5a6a', marginTop: 1 }}>
                          ⚔️ {boss.condition.label} · ⏳ {daysLeft} дн. осталось
                        </div>
                      </div>
                      <div style={{
                    ...
                    {/* HP bar */}
                    <div style={{ height: 6, background: '#1a1a24', borderRadius: 3, marginBottom: 8, overflow: 'hidden' }}>
                      <div style={{
                        height: '100%', borderRadius: 3,
                        width: `${stats.pct}%`,
                        background: stats.pct >= 100 ? '#4caf50' : rc,
                        transition: 'width 0.4s ease',
                      }} />
                    </div>

                    {/* Progress numbers */}
                    <div style={{ fontSize: 10, color: '#7a7a82', marginBottom: 8, textAlign: 'right' }}>
                      {fmt(stats.totalDone)} / {fmt(stats.target)} {stats.unit}
                      {stats.remaining > 0 && (
                        <span style={{ color: '#5a5a6a' }}> · осталось: {fmt(stats.remaining)} {stats.unit}</span>
                      )}
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                      {raid.participants.map(p => {
                        ...
                        const hasPersonalTarget = pt?.target != null;
                        const personalPct = hasPersonalTarget && pt.target > 0
                          ? Math.min(100, Math.round(pt.done / pt.target * 100))
                          : null;

                        // Имя: ищем в guildMembers или показываем nickname
                        const memberData = guildMembers.find(m => m.nickname === p.name);
                        const displayName = memberData?.character_name || p.name;

                        return (
                          <div key={p.name}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
                              {/* Role emoji for combo raids */}
                              {p.role && boss.condition.roles && (
                                <span style={{ fontSize: 12 }}>
                                  {boss.condition.roles[p.role]?.emoji || ''}
                                </span>
                              )}
                              <span style={{ fontSize: 10, color: '#b0b0bc', flex: 1, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                {displayName}
                              </span>
                              <span style={{ fontSize: 10, fontWeight: 700, color: rc, flexShrink: 0 }}>
                                {hasPersonalTarget
                                  ? `${fmt(pt.done)} / ${fmt(pt.target)} ${pt.unit || stats.unit}`
                                  : `${fmt(dmg)} ${stats.unit}`
                                }
                              </span>
                            </div>
                            {/* Mini bar per player */}
                            {hasPersonalTarget && personalPct !== null && (
                              <div style={{ height: 3, background: '#1a1a24', borderRadius: 2, overflow: 'hidden' }}>
                                <div style={{
                                  height: '100%', borderRadius: 2,
                                  width: `${personalPct}%`,
                                  background: personalPct >= 100 ? '#4caf50' : rc + 'cc',
                                }} />
                              </div>
                            )}
                          </div>
...
function ChallengesView({ challengeState, challengeProgress, activeChallengeBuff, challengeFailDebuff, challengeCooldownDays, challengeAchievements, level, onStart }) {
  ...
  if (challengeProgress && challengeState.active) {
    const { def, dayResults, elapsed, missedSoFar, maxAllowed, perfectDays } = challengeProgress;
    ...
    return (
      <div>
        {/* Active buff/debuff banners */}
        {activeChallengeBuff && (
          <div style={{ padding: '10px 14px', borderRadius: 12, background: '#1a2a18', border: '1px solid #3a5a2a', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
            <Sparkles size={16} color="#7adf5a" />
            <div>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#7adf5a' }}>{activeChallengeBuff.name}</div>
              <div style={{ fontSize: 10.5, color: '#5a8a4a' }}>+{activeChallengeBuff.xpBonusPct}% XP · осталось до {new Date(activeChallengeBuff.expiresDate).toLocaleDateString('ru-RU')}</div>
            </div>
          </div>
        )}
        {challengeFailDebuff && (
          <div style={{ padding: '10px 14px', borderRadius: 12, background: '#2a1818', border: '1px solid #5a2a2a', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
            <Skull size={16} color="#e05f4a" />
            <div>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#e05f4a' }}>Сломленная клятва</div>
              <div style={{ fontSize: 10.5, color: '#8a4a4a' }}>−10% XP · {challengeFailDebuff.daysLeft} дн. осталось</div>
            </div>
          </div>
        )}

        <div style={{ background: '#1c1c22', border: '1.5px solid ' + (catDef?.color || '#e0a868') + '44', borderRadius: 16, padding: 18, marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: 10, background: (catDef?.color || '#e0a868') + '22', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <CatIcon size={20} color={catDef?.color || '#e0a868'} />
            </div>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 15, fontWeight: 800, color: '#f0f0f4' }}>{def.name}</div>
              <div style={{ fontSize: 11, color: '#8a8a92', marginTop: 1 }}>{def.description}</div>
            </div>
          </div>

          {/* Quote */}
          <div style={{ fontSize: 11, color: '#6a6a72', fontStyle: 'italic', textAlign: 'center', marginBottom: 14 }}>«{def.quote}»</div>

          {/* Progress bar */}
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
            <span style={{ fontSize: 11, color: '#aeaeb6' }}>День {elapsed} / {def.duration}</span>
            <span style={{ fontSize: 11, color: '#aeaeb6' }}>{progressPct}%</span>
          </div>
          <div style={{ height: 8, background: '#25252c', borderRadius: 4, overflow: 'hidden', marginBottom: 14 }}>
            <div style={{ height: '100%', width: progressPct + '%', background: `linear-gradient(90deg, ${catDef?.color || '#e0a868'}, ${catDef?.color || '#e0a868'}aa)`, borderRadius: 4, transition: 'width 0.3s' }} />
          </div>

          {/* Day grid */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 4, marginBottom: 14 }}>
            {dayResults.map((result, i) => {
              const bg = result === null ? '#1a1a22' : result ? '#1a3a1a' : '#3a1a1a';
              const border = result === null ? '#25252c' : result ? '#3a6a3a' : '#6a3a3a';
              const emoji = result === null ? '' : result ? '✓' : '✕';
              const color = result ? '#5adf5a' : '#e05f4a';
              return (
                <div key={i} style={{
                  height: 30, borderRadius: 6, background: bg, border: '1px solid ' + border,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: '#5adf5a' }}>{successDays}</div>
              <div style={{ fontSize: 10, color: '#6a6a72' }}>Выполнено</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: '#e05f4a' }}>{missedSoFar}</div>
              <div style={{ fontSize: 10, color: '#6a6a72' }}>Пропущено</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: '#aeaeb6' }}>{maxAllowed}</div>
              <div style={{ fontSize: 10, color: '#6a6a72' }}>Допуск</div>
            </div>
          </div>

          {/* Reward preview */}
          <div style={{ marginTop: 14, padding: '8px 12px', background: '#15151a', borderRadius: 8 }}>
            <div style={{ fontSize: 11, color: '#8a8a92', marginBottom: 4 }}>Награда за успех:</div>
            <div style={{ fontSize: 12, color: '#f0d272' }}>
              💎 {def.crystals} кристаллов · ⚡ {def.buff.name} (+{def.buff.xpBonusPct}% XP, {def.buff.days} дн.)
              {def.title && <span> · 👑 Титул: {def.title}</span>}
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#1c1c22', border: '1.5px solid ' + (catDef?.color || '#e0a868') + '44', borderRadius: 16, padding: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11.5, color: '#8a8a92' }}>{def.duration} дней · допуск: {def.allowedMisses} пропуск(ов)</div>
            </div>
          </div>
