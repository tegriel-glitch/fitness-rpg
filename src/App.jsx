...
// artwork (/public/character/equipment_silhouette.png, 520x902 — widened canvas with the
...
const SILHOUETTE_SLOT_BOXES = {
  head:      { left: 70.0,  top: 7.2,  width: 28.85, height: 16.63 },
  body:      { left: 27.45, top: 24.2, width: 34.6,  height: 19.96 },
  weapon:    { left: 0,     top: 36.9, width: 28.85, height: 16.63 },
  hands:     { left: 64.75, top: 36.9, width: 28.85, height: 16.63 },
  legs:      { left: 35.58, top: 66.2, width: 28.85, height: 16.63 },
  accessory: { left: 1.15,  top: 66.0, width: 28.85, height: 16.63 },
};
...
const EquippedGear = React.memo(function EquippedGear({ equippedShopItems, lockedClassId, onSell, onSlotTap }) {
      ...
      <React.Fragment key={slot.key}>
        ...
        >
          {item
            ? (item.image
                ? <img src={item.image} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                : <item.icon size={38} color={rarity.color} />)
            : <Plus size={28} color="#5a5a62" />}
          {item && !active && (
            <div style={{
              position: 'absolute', top: 4, right: 4,
  ...
  return (
    <div style={styles.equippedGearWrap}>
      <div style={{ position: 'relative', width: '100%', paddingTop: `${(902 / 520) * 100}%` }}>
        <img
