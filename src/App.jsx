  ...
  return (
    <div style={styles.header}>
      ...
      <div style={styles.healthBarsWrap}>
        <HealthBar value={healthState.physical} color="#e8633c" />
        <HealthBar value={healthState.mental} color="#4f7cff" />
...
const HealthBar = React.memo(function HealthBar({ value, color }) {
  return (
