  ...
  return (
    <div style={styles.header}>
      ...
      <div style={styles.healthBarsMergedWrap}>
        <HealthBar value={healthState.physical} gradient="linear-gradient(90deg, #3a0f16 0%, #7a1f2c 45%, #9c2c3a 100%)" position="top" />
        <HealthBar value={healthState.mental} gradient="linear-gradient(90deg, #12173c 0%, #26339c 45%, #3a4fc4 100%)" position="bottom" />
      </div>
...
const HealthBar = React.memo(function HealthBar({ value, gradient, position }) {
  return (
    <div style={{ ...styles.healthBarTrack, borderBottom: position === 'top' ? '1px solid rgba(0,0,0,0.35)' : 'none' }}>
      <div style={{
