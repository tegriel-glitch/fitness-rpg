  ...
  const healthState = useMemo(() => {
    ...
    combined.forEach((entry) => {
      ...
      if (entry._kind === 'activity') {
        ...
        // Patch 2: info overload — 200+ pages 3 days in a row → stress stack
        if (entry.activity === 'reading' && entry.pages) {
          ...
          const day0 = heavyReadingByDate[dateKey(d)] || 0;
          const day1 = heavyReadingByDate[dateKey(new Date(d.getTime() - 86400000))] || 0;
          const day2 = heavyReadingByDate[dateKey(new Date(d.getTime() - 2 * 86400000))] || 0;
          if (day0 >= 200 && day1 >= 200 && day2 >= 200 && !infoOverloadAppliedDates.has(entry.date)) {
