  ...
  return (
    <div style={styles.header}>
      ...
      <div style={styles.healthBarsMergedWrap}>
        <HealthBar value={healthState.physical} color="#e8633c" position="top" />
        <HealthBar value={healthState.mental} color="#4f7cff" position="bottom" />
      </div>
...
const HealthBar = React.memo(function HealthBar({ value, color, position }) {
  return (
    <div style={{ ...styles.healthBarTrack, borderBottom: position === 'top' ? '1px solid rgba(0,0,0,0.35)' : 'none' }}>
      <div style={{
        ...styles.healthBarFill, width: `${value}%`, background: color,
        boxShadow: `0 0 10px ${color}88, inset 0 1px 0 rgba(255,255,255,0.3)`,
      }} />
