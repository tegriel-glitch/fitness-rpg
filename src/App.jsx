...
const COMBO_ACHIEVEMENTS = [
  ...
  },
  {
    ...
    requires: ['walking_12k', 'strength'],
    description: '12к+ шагов + силовая тренировка в один день',
...
export default function App() {
  ...
  useEffect(() => {
    ...
    avatarEmoji, equippedAvatarFrame, purchasedFrameIds,
  ]);
          ...
          {isParticipant && (() => {
            ...
            return (
              <div style={{ marginBottom: 10 }}>
                ...
                {/* Override input — shown only when correction mode active */}
                {overrideMode && (
                  <div style={{ display: 'flex', gap: 8 }}>
                    <input
                      type="number"
                      placeholder={`Верное значение (${boss.condition.unit})...`}
                      value={contribValue}
