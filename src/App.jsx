          ...
          <div style={{ borderTop: `1px solid ${rc.color}22`, paddingTop: 14, marginBottom: 14 }}>
            ...
            {setComplete ? (
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#15151a', border: '1px solid #24242c', borderRadius: 10, padding: 10 }}>
                {nextItem.image && (
                  <img src={nextItem.image} alt="" style={{ width: 44, height: 44, borderRadius: 9, objectFit: 'cover', flexShrink: 0 }}
                    onError={(e) => { e.currentTarget.style.display = 'none'; }} />
                )}
                <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div key={bossId} style={{ background: '#15151a', border: `1px solid ${rc.color}33`, borderRadius: 12, padding: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                {setItems.map((it) => {
                  ...
                  return (
                    <div key={it.itemId} title={it.name} style={{
                      position: 'relative', width: 40, height: 40, borderRadius: 9, overflow: 'hidden', flexShrink: 0,
                      border: `1px solid ${has ? rc.color + '66' : '#2a2a32'}`, opacity: has ? 1 : 0.35,
                    }}>
                      {it.image && (
                      ...
                      {!has && (
                        <div style={{ position: 'absolute', inset: 0, background: 'rgba(10,10,13,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14 }}>
                          🔒
                        </div>
                      )}
                    </div>
