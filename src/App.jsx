...
export default function App() {
  ...
  function buildSnapshot(overrides = {}) {
    ...
    return {
      ...
      // current_level сохраняется отдельно через levelSaveEffect
      ...overrides,
    };
  }
  ...
  // Отдельно сохраняем current_level при его изменении — levelState это useMemo, не попадает в основной save
  useEffect(() => {
