        ...
        {item && item.price > 0 && onSell && (
          <button
            ...
            style={{
              ...
              background: '#1a1a22', border: '1px solid #3a3a42', borderRadius: 6,
              padding: '2px 5px', fontSize: 8, color: '#8a8a92', fontWeight: 700, cursor: 'pointer',
            }}
          >
            Продать
          </button>
